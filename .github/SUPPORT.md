...
Thanks for using crantr. We're sorry if you're having trouble, but don't worry,
...
* Search GitHub for [_issues_ with the crantr package](https://github.com/flyconnectome/crantr/issues).
...
* If you need to report a *new* bug:
  please [file an issue](https://github.com/flyconnectome/crantr/issues/new).
* If you're not sure:
